...
function Novinki({ addToKarzinka, Context }) {
  ...
  return (
    <div className="container_product mini_card grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-6">
      {data?.splice(8, 12).map((item) => (
        <div
          key={item.id}
